...
crimeInit = function(crimeLayersLang) {
	...
	TimerContainer = function(opts, layer) {
		TimerContainer.superclass.constructor.call(this, opts, layer);
		this.imageName = "timer";		
	};
	YAHOO.lang.extend(TimerContainer, LogicContainer, {
